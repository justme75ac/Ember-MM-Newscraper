...
#Region "Methods"
    ...
    Private Sub pbApiKeyInfo_Click(sender As Object, e As EventArgs) Handles pbApiKeyInfo.Click
        Functions.Launch("https://theporndb.net/api")
    End Sub
    ...
    Private Sub TextBox_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles txtApiKey.TextChanged
    ...
    Private Sub Setup()
        ...
        lblApiKey.Text = String.Concat("ThePornDB API Key", ":")
