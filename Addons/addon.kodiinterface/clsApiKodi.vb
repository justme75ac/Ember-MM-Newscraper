...
#Region "Methods"
        ...
        Public Async Function GetPlaycount_TVEpisode(ByVal mDBElement As Database.DBElement, ByVal GenericSubEvent As IProgress(Of Addon.GenericSubEventCallBackAsync), ByVal GenericMainEvent As IProgress(Of Addon.GenericEventCallBackAsync)) As Task(Of WatchedState)
            ...
            Try
                ...
                If KodiElement IsNot Nothing Then
                    'check if we have to retrieve the PlayCount from Kodi
                    If Not mDBElement.MainDetails.PlayCount = KodiElement.playcount OrElse Not mDBElement.TVEpisode.LastPlayed = KodiElement.lastplayed Then
        ...
        Public Async Function UpdateInfo_TVEpisode(ByVal mDBElement As Database.DBElement, ByVal blnSendHostNotification As Boolean, ByVal GenericSubEvent As IProgress(Of Addon.GenericSubEventCallBackAsync), ByVal GenericMainEvent As IProgress(Of Addon.GenericEventCallBackAsync)) As Task(Of Boolean)
            ...
            Try
                ...
                If KodiElement IsNot Nothing Then
                    ...
                    If Master.eSettings.Options.Global.DigitGrpSymbolVotesEnabled Then
                        If mDBElement.MainDetails.VotesSpecified Then
                            Dim vote As String = Double.Parse(mDBElement.TVEpisode.Votes, CultureInfo.InvariantCulture).ToString("N0", CultureInfo.CurrentCulture)
                            If vote IsNot Nothing Then
                                mVotes = vote
                            End If
                        End If
                    ...
                    'arrays
                    'Directors
                    Dim mDirectorList As List(Of String) = If(mDBElement.MainDetails.DirectorsSpecified, mDBElement.TVEpisode.Directors, New List(Of String))

                    'Writers (Credits)
                    Dim mWriterList As List(Of String) = If(mDBElement.MainDetails.CreditsSpecified, mDBElement.TVEpisode.Credits, New List(Of String))
                    ...
                    Else
                        ...
                        'Send message to Kodi?
                        If blnSendHostNotification = True Then
                            Await SendMessage("Ember Media Manager", If(bIsNew, Master.eLang.GetString(881, "Added"), Master.eLang.GetString(1408, "Updated")) & ": " & mDBElement.MainDetails.Title & ": " & mDBElement.TVEpisode.Title).ConfigureAwait(False)
                        End If
            ...
            Try
                ...
                If KodiElement IsNot Nothing Then
                    ...
                    Else
                        'Send message to Kodi?
                        If blnSendHostNotification = True Then
                            Await SendMessage("Ember Media Manager", String.Format("{0}: {1}: {2}", Master.eLang.GetString(1024, "Removed"), mDBElement.MainDetails.Title, mDBElement.TVEpisode.Title)).ConfigureAwait(False)
                        End If
...
#Region "Methods"
        ...
        Public Async Function ConnectAsync(hostName As String, port As Integer) As Task Implements ISocket.ConnectAsync
            ...
            Await Task.Run(Sub() _socket.Connect(hostName, port))
        End Function
