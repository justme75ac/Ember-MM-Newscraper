...
#Region "Methods"
    ...
    Private Sub btnDown_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDown.Click
        Dim order As Integer = ModulesManager.Instance.externalScrapersModules_Trailer_Movie.FirstOrDefault(Function(p) p.AssemblyName = AEBN_trailer._AssemblyName).ModuleOrder
        If order < ModulesManager.Instance.externalScrapersModules_Trailer_Movie.Count - 1 Then
            ...
            ModulesManager.Instance.externalScrapersModules_Trailer_Movie.FirstOrDefault(Function(p) p.AssemblyName = AEBN_trailer._AssemblyName).ModuleOrder = order + 1
